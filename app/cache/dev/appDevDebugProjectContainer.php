...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'old_sound_rabbit_mq.test_consumer' => 'getOldSoundRabbitMq_TestConsumerService',
            'old_sound_rabbit_mq.test_producer' => 'getOldSoundRabbitMq_TestProducerService',
            'profiler' => 'getProfilerService',
            'profiler_listener' => 'getProfilerListenerService',
            'property_accessor' => 'getPropertyAccessorService',
            'rabbitmq.callback.service' => 'getRabbitmq_Callback_ServiceService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('font_bootstrap_1' => array(0 => array(0 => ($this->targetDirs[2].'/../src/masterofcodeBundle/Resources/public/fonts/glyphicons-halflings-regular.woff')), 1 => array(), 2 => array('output' => 'fonts/glyphicons-halflings-regular.woff')), 'font_bootstrap_2' => array(0 => array(0 => ($this->targetDirs[2].'/../src/masterofcodeBundle/Resources/public/fonts/glyphicons-halflings-regular.woff2')), 1 => array(), 2 => array('output' => 'fonts/glyphicons-halflings-regular.woff2')))), 'config');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'masterofcodeBundle', ($this->targetDirs[2].'/Resources/masterofcodeBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'masterofcodeBundle', ($this->targetDirs[3].'/src/masterofcodeBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/masterofcodeBundle/Resources/config/doctrine') => 'masterofcodeBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'masterofcodeBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('masterofcodeBundle' => 'masterofcodeBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0961bf45baa378b884b77f86da5b28e7a06eda71274379d8da43368e1d89861c');
    ...
    {
        return $this->services['old_sound_rabbit_mq.connection.default'] = call_user_func(array(new \OldSound\RabbitMqBundle\RabbitMq\AMQPConnectionFactory('PhpAmqpLib\\Connection\\AMQPConnection', array('host' => 'localhost', 'port' => 5672, 'user' => 'guest', 'password' => 'guest', 'vhost' => '/', 'lazy' => false, 'connection_timeout' => 3, 'read_write_timeout' => 3, 'ssl_context' => array(), 'keepalive' => false, 'heartbeat' => 0)), 'createConnection'));
    }
    ...
    {
        $a = $this->get('old_sound_rabbit_mq.test_producer');
        $b = $this->get('old_sound_rabbit_mq.test_consumer');
    ...
    /**
     * Gets the 'old_sound_rabbit_mq.test_consumer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getOldSoundRabbitMq_TestConsumerService()
    {
        $this->services['old_sound_rabbit_mq.test_consumer'] = $instance = new \OldSound\RabbitMqBundle\RabbitMq\Consumer($this->get('old_sound_rabbit_mq.connection.default'));

        $instance->setExchangeOptions(array('name' => 'test', 'type' => 'direct', 'passive' => false, 'durable' => true, 'auto_delete' => false, 'internal' => false, 'nowait' => false, 'declare' => true, 'arguments' => NULL, 'ticket' => NULL));
        $instance->setQueueOptions(array('name' => 'test', 'passive' => false, 'durable' => true, 'exclusive' => false, 'auto_delete' => false, 'nowait' => false, 'arguments' => NULL, 'ticket' => NULL, 'routing_keys' => array()));
        $instance->setCallback(array(0 => $this->get('rabbitmq.callback.service'), 1 => 'execute'));

        return $instance;
    }

    /**
     * Gets the 'old_sound_rabbit_mq.test_producer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getOldSoundRabbitMq_TestProducerService()
    {
        $this->services['old_sound_rabbit_mq.test_producer'] = $instance = new \OldSound\RabbitMqBundle\RabbitMq\Producer($this->get('old_sound_rabbit_mq.connection.default'));
    ...
    /**
     * Gets the 'rabbitmq.callback.service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \masterofcodeBundle\Command\ConvertCommand A masterofcodeBundle\Command\ConvertCommand instance.
     */
    protected function getRabbitmq_Callback_ServiceService()
    {
        return $this->services['rabbitmq.callback.service'] = new \masterofcodeBundle\Command\ConvertCommand($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'masterofcodeBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/oldsound/rabbitmq-bundle/Resources/views'), 'OldSoundRabbitMq');
        $instance->addPath(($this->targetDirs[3].'/src/masterofcodeBundle/Resources/views'), 'masterofcode');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('569d38f648b6e92d777edd0636482c411b1ec385');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55ee3301cea035.83162139')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'masterofcodeBundle' => 'masterofcodeBundle\\masterofcodeBundle',
            ...
            'secret' => '569d38f648b6e92d777edd0636482c411b1ec385',
            'locale' => 'en',
            ...
            'kernel.secret' => '569d38f648b6e92d777edd0636482c411b1ec385',
